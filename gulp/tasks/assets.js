...
gulp.task('scripts', () =>
  ...
  gulp.src(['src/javascript/jquery.min.js',
            'src/javascript/jquery.scrollex.min.js',
            'src/javascript/jquery.scrolly.min.js',
            'src/javascript/skel.min.js',
...
gulp.task('serve', (done) => {
  ...
  gulp.watch('src/javascript/**/*.js', gulp.series('scripts', reload));
